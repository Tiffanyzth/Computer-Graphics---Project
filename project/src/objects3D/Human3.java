...
public class Human3 {
 ...
 { 
		 ...
		 float theta2 = (float) (delta * 10 * Math.PI);
		 	float LimbRotation2;
		 	if (GoodAnimation){
		 		LimbRotation2 = (float) Math.cos(theta2)*45;
		 	}else{
		 		LimbRotation2 =0;
		 	} 
		            ...
		            GL11.glPushMatrix(); {
		               ...
		               GL11.glMaterial( GL11.GL_FRONT, GL11.GL_AMBIENT_AND_DIFFUSE,  Utils.ConvertForGL(pink));
		                GL11.glPushMatrix(); {
		                    ...
		                    GL11.glRotatef(LimbRotation2,0.0f,1.0f,1.0f);
		                    sphere.DrawSphere(0.5f, 32, 32); 
				                  ...
				                  GL11.glColor3f(white[0], white[1], white[2]);
				 		           GL11.glMaterial( GL11.GL_FRONT,  GL11.GL_AMBIENT_AND_DIFFUSE,  Utils.ConvertForGL(white));
				 		            GL11.glPushMatrix(); {
				 		                ...
				 		                cylinder.DrawCylinder(0.6f,0.30f,32);
		                ...
		                GL11.glPushMatrix(); {
		                   ...
		                   GL11.glMaterial( GL11.GL_FRONT, GL11.GL_AMBIENT_AND_DIFFUSE,  Utils.ConvertForGL(white));
		                    GL11.glPushMatrix(); {
		                        ...
		                        GL11.glRotatef(LimbRotation2/3*2,0.0f,1.0f,0.0f); 
		                        ...
		                        GL11.glPushMatrix(); {
		                           ...
		                           GL11.glMaterial( GL11.GL_FRONT, GL11.GL_AMBIENT_AND_DIFFUSE,  Utils.ConvertForGL(white));
		                            GL11.glPushMatrix(); {
		                            	...
		                            	GL11.glRotatef((LimbRotation2/9*4),0.0f,1.0f,0.0f);
