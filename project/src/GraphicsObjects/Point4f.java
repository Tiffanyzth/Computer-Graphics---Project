...
public class Point4f {
	...
	public Point4f PlusVector(Vector4f Additonal) { 
		...
		//When point plus a vector, return a point whose (x,y,z) equal to the origin point's (x,y,z) plus 
		//the vector's (x,y,z) separately.
	...
	public Point4f MinusVector(Vector4f Minus) { 
		...
		//When point minus a vector, return a point whose (x,y,z) equal to the origin point's (x,y,z) minus 
		//the vector's (x,y,z) separately.
		//X = Xpoint - Xvector; Y = Ypoint - Yvector; Z = Zpoint - Zvector;
	}
	...
	public Vector4f MinusPoint(Point4f Minus) { 
		...
		//When point minus the other point, return a vector whose (x,y,z) equal to the origin point's (x,y,z) minus 
		//the other point's (x,y,z) separately. The direction is from the other point to the origin point.
